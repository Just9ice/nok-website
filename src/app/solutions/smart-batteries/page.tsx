...
const mediaItems = [
  { type: "image", src: "/projects/batteries.jpeg", alt: "EV Batteries" },
  {
    type: "video",
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="text-xl leading-relaxed text-slate-800 dark:text-white/85">
              &ldquo;Our smart battery systems seamlessly integrate with
              existing solar setups or the grid, ensuring critical appliances
              and business operations are never disrupted.&rdquo;
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {mediaItems.map((media, idx) => (
            <motion.button
              ...
              className="group relative aspect-video sm:aspect-square overflow-hidden rounded-3xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
        ...
        {activeItem && lightboxIndex !== null && (
          ...
          >
            ...
            <button
              ...
              className="absolute left-3 md:left-6 z-10 flex items-center justify-center w-12 h-12 rounded-full bg-white/10 hover:bg-blue-500/70 border border-white/20 text-white transition-all duration-200 hover:scale-110"
              aria-label="Previous"
            >
              <ChevronLeft size={26} />
            </button>
            ...
            <button
              ...
              className="absolute right-3 md:right-6 z-10 flex items-center justify-center w-12 h-12 rounded-full bg-white/10 hover:bg-blue-500/70 border border-white/20 text-white transition-all duration-200 hover:scale-110"
              aria-label="Next"
            >
